    ...
    <div className="max-w-screen-2xl container mx-auto sticky top-0 z-50">
      <div className="navbar bg-base-100 shadow-sm justify-between">
        ...
        <div className="navbar-end flex items-center gap-8">
          <ul className="menu menu-horizontal gap-8 hidden lg:flex">
            {navItems}
          </ul>
        </div>
        ...
        <div className="navbar-end gap-6">
          ...
          <div className="hidden md:block ">
            <label className="px-3 py-2 border border-base-300 bg-base-100 rounded-md flex items-center gap-16">
              <input
                type="text"
